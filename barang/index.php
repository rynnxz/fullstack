...
$sql = "SELECT * FROM barang LIMIT $start, $per_page";
...
if ($result === false) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<table>";
        echo "<tr><th>No.</th><th>Kode Barang</th><th>Nama Barang</th><th>Jumlah Barang</th><th>Satuan Barang</th><th class='hargaStyle'>Harga Barang</th></tr>";
        ...
        $sql_total = "SELECT COUNT(*) AS total FROM barang";
